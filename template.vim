...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['{normal.black}', '{normal.red}', '{normal.green}', '{normal.yellow}', '{normal.blue}', '{normal.magenta}', '{normal.cyan}', '{normal.white}', '{bright.black}', '{bright.red}', '{bright.green}', '{bright.yellow}', '{bright.blue}', '{bright.magenta}', '{bright.cyan}', '{bright.white}']
    if has('nvim')
      let g:terminal_color_0 = '{normal.black}'
      let g:terminal_color_1 = '{normal.red}'
      let g:terminal_color_2 = '{normal.green}'
      let g:terminal_color_3 = '{normal.yellow}'
      let g:terminal_color_4 = '{normal.blue}'
      let g:terminal_color_5 = '{normal.magenta}'
      let g:terminal_color_6 = '{normal.cyan}'
      let g:terminal_color_7 = '{normal.white}'
      let g:terminal_color_8 = '{bright.black}'
      let g:terminal_color_9 = '{bright.red}'
      let g:terminal_color_10 = '{bright.green}'
      let g:terminal_color_11 = '{bright.yellow}'
      let g:terminal_color_12 = '{bright.blue}'
      let g:terminal_color_13 = '{bright.magenta}'
      let g:terminal_color_14 = '{bright.cyan}'
      let g:terminal_color_15 = '{bright.white}'
    endif
    if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
      hi Normal guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi CursorLineNr guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi FoldColumn guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi SignColumn guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi VertSplit guifg=#665c54 guibg=NONE gui=NONE cterm=NONE
    else
      hi Normal guifg={bright.white} guibg={normal.black} gui=NONE cterm=NONE
      hi CursorLineNr guifg={bright.yellow} guibg=#3c3836 gui=NONE cterm=NONE
      hi FoldColumn guifg={bright.black} guibg=#3c3836 gui=NONE cterm=NONE
      hi SignColumn guifg={bright.white} guibg=#3c3836 gui=NONE cterm=NONE
      hi VertSplit guifg=#665c54 guibg={normal.black} gui=NONE cterm=NONE
    endif
    hi ColorColumn guifg=NONE guibg=#3c3836 gui=NONE cterm=NONE
    hi Comment guifg={bright.black} guibg=NONE gui=italic cterm=italic
    hi CursorLine guifg=NONE guibg=#3c3836 gui=NONE cterm=NONE
    hi Error guifg={bright.red} guibg={normal.black} gui=bold,reverse cterm=bold,reverse
    hi ErrorMsg guifg={normal.black} guibg={bright.red} gui=bold cterm=bold
    hi Folded guifg={bright.black} guibg=#3c3836 gui=italic cterm=italic
    ...
    hi Pmenu guifg={bright.white} guibg=#504945 gui=NONE cterm=NONE
    hi PmenuSbar guifg=NONE guibg=#504945 gui=NONE cterm=NONE
    hi PmenuSel guifg=#504945 guibg={bright.blue} gui=bold cterm=bold
    hi PmenuThumb guifg=NONE guibg=#7c6f64 gui=NONE cterm=NONE
    hi SpecialKey guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
    hi StatusLine guifg=#504945 guibg={bright.white} gui=reverse cterm=reverse
    hi StatusLineNC guifg=#3c3836 guibg={normal.white} gui=reverse cterm=reverse
    hi TabLine guifg=#7c6f64 guibg=#3c3836 gui=NONE cterm=NONE
    hi TabLineFill guifg=#7c6f64 guibg=#3c3836 gui=NONE cterm=NONE
    hi TabLineSel guifg={bright.green} guibg=#3c3836 gui=NONE cterm=NONE
    ...
    hi WildMenu guifg={bright.blue} guibg=#504945 gui=bold cterm=bold
    hi Conceal guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
    hi Cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
    hi DiffAdd guifg={bright.green} guibg={normal.black} gui=reverse cterm=reverse
    hi DiffChange guifg={bright.cyan} guibg={normal.black} gui=reverse cterm=reverse
    hi DiffDelete guifg={bright.red} guibg={normal.black} gui=reverse cterm=reverse
    hi DiffText guifg={bright.yellow} guibg={normal.black} gui=reverse cterm=reverse
    hi Directory guifg={bright.green} guibg=NONE gui=bold cterm=bold
    hi EndOfBuffer guifg={normal.black} guibg=NONE gui=NONE cterm=NONE
    hi IncSearch guifg=#fe8019 guibg={normal.black} gui=reverse cterm=reverse
    hi ModeMsg guifg={bright.yellow} guibg=NONE gui=bold cterm=bold
    hi MoreMsg guifg={bright.yellow} guibg=NONE gui=bold cterm=bold
    hi Question guifg=#fe8019 guibg=NONE gui=bold cterm=bold
    hi Search guifg={bright.yellow} guibg={normal.black} gui=reverse cterm=reverse
    hi SpellBad guifg={bright.red} guibg=NONE guisp={bright.red} gui=italic,undercurl cterm=italic,underline
    hi SpellCap guifg={bright.blue} guibg=NONE guisp={bright.blue} gui=italic,undercurl cterm=italic,underline
    hi SpellLocal guifg={bright.cyan} guibg=NONE guisp={bright.cyan} gui=italic,undercurl cterm=italic,underline
    hi SpellRare guifg={bright.magenta} guibg=NONE guisp={bright.magenta} gui=italic,undercurl cterm=italic,underline
    hi Title guifg={bright.green} guibg=NONE gui=bold cterm=bold
    hi WarningMsg guifg={bright.red} guibg=NONE gui=bold cterm=bold
    hi Boolean guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
    hi Character guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
    hi Conditional guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
    hi Constant guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
    hi Define guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
    hi Debug guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
    hi Delimiter guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
    hi Error guifg={bright.red} guibg={normal.black} gui=bold,reverse cterm=bold,reverse
    hi Exception guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
    hi Float guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
    hi Function guifg={bright.green} guibg=NONE gui=bold cterm=bold
    hi Identifier guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
    hi Ignore guifg=fg guibg=NONE gui=NONE cterm=NONE
    hi Include guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
    hi Keyword guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
    hi Label guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
    hi Macro guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
    hi Number guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
    hi Operator guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
    hi PreCondit guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
    hi PreProc guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
    hi Repeat guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
    hi SpecialChar guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
    hi SpecialComment guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
    hi Statement guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
    hi StorageClass guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
    hi Special guifg=#fe8019 guibg=NONE gui=italic cterm=italic
    hi String guifg={bright.green} guibg=NONE gui=italic cterm=italic
    hi Structure guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
    hi Todo guifg=fg guibg={normal.black} gui=bold,italic cterm=bold,italic
    hi Type guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
    hi Typedef guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
    hi Underlined guifg={bright.blue} guibg=NONE guisp={bright.blue} gui=underline cterm=underline
    ...
    hi NormalMode guifg={normal.white} guibg={normal.black} gui=reverse cterm=reverse
    hi InsertMode guifg={bright.blue} guibg={normal.black} gui=reverse cterm=reverse
    hi ReplaceMode guifg={bright.cyan} guibg={normal.black} gui=reverse cterm=reverse
    hi VisualMode guifg=#fe8019 guibg={normal.black} gui=reverse cterm=reverse
    hi CommandMode guifg={bright.magenta} guibg={normal.black} gui=reverse cterm=reverse
    hi Warnings guifg=#fe8019 guibg={normal.black} gui=reverse cterm=reverse
    if has('nvim')
      hi! link TermCursor Cursor
      hi TermCursorNC guifg=#3c3836 guibg={bright.white} gui=NONE cterm=NONE
    endif
    if !(get(g:, 'gruvbox_plugin_hi_groups', 0) || get(g:, 'gruvbox_filetype_hi_groups', 0))
      finish
    endif
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      hi ALEError guifg=NONE guibg=NONE guisp={bright.red} gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
      hi ALEWarning guifg=NONE guibg=NONE guisp={bright.red} gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
      hi ALEInfo guifg=NONE guibg=NONE guisp={bright.blue} gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
      hi ALEErrorSign guifg={bright.red} guibg=#3c3836 gui=NONE cterm=NONE
      hi ALEWarningSign guifg={bright.yellow} guibg=#3c3836 gui=NONE cterm=NONE
      hi ALEInfoSign guifg={bright.blue} guibg=#3c3836 gui=NONE cterm=NONE
      hi BufTabLineCurrent guifg={normal.black} guibg={normal.white} gui=NONE cterm=NONE
      hi BufTabLineActive guifg={normal.white} guibg=#504945 gui=NONE cterm=NONE
      hi BufTabLineHidden guifg=#7c6f64 guibg=#3c3836 gui=NONE cterm=NONE
      hi BufTabLineFill guifg={normal.black} guibg={normal.black} gui=NONE cterm=NONE
      hi CocErrorSign guifg={bright.red} guibg={normal.black} gui=NONE cterm=NONE
      hi CocWarningSign guifg={bright.yellow} guibg={normal.black} gui=NONE cterm=NONE
      hi CocInfoSign guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi CocHintSign guifg=#504945 guibg=NONE gui=NONE cterm=NONE
      hi CocErrorFloat guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi CocWarningFloat guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi CocInfoFloat guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi CocHintFloat guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi CocSelectedText guifg=#3c3836 guibg={normal.black} gui=NONE cterm=NONE
      hi CocCodeLens guifg=#504945 guibg=NONE gui=NONE cterm=NONE
      hi CtrlPMatch guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi CtrlPNoEntries guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi CtrlPPrtBase guifg=#504945 guibg=NONE gui=NONE cterm=NONE
      hi CtrlPPrtCursor guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi CtrlPLinePre guifg=#504945 guibg=NONE gui=NONE cterm=NONE
      hi CtrlPMode1 guifg={bright.blue} guibg=#504945 gui=bold cterm=bold
      hi CtrlPMode2 guifg={normal.black} guibg={bright.blue} gui=bold cterm=bold
      hi CtrlPStats guifg={normal.white} guibg=#504945 gui=bold cterm=bold
      if !get(g:, 'gruvbox_bold', 1)
        hi CtrlPMode1 gui=NONE cterm=NONE
        hi CtrlPMode2 gui=NONE cterm=NONE
        hi CtrlPStats gui=NONE cterm=NONE
      endif
      hi DirvishPathTail guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi DirvishArg guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi! link EasyMotionTarget Search
      hi! link EasyMotionShade Comment
      hi gitcommitSelectedFile guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi gitcommitDiscardedFile guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      if get(g:, 'gruvbox_transp_bg', 0)
        hi GitGutterAdd guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
        hi GitGutterChange guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
        hi GitGutterDelete guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
        hi GitGutterChangeDelete guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      else
        hi GitGutterAdd guifg={bright.green} guibg=#3c3836 gui=NONE cterm=NONE
        hi GitGutterChange guifg={bright.cyan} guibg=#3c3836 gui=NONE cterm=NONE
        hi GitGutterDelete guifg={bright.red} guibg=#3c3836 gui=NONE cterm=NONE
        hi GitGutterChangeDelete guifg={bright.cyan} guibg=#3c3836 gui=NONE cterm=NONE
      endif
      if get(g:, 'indent_guides_auto_colors', 0)
        if get(g:, 'gruvbox_invert_indent_guides', 0)
          hi IndentGuidesOdd guifg={normal.black} guibg=#504945 gui=reverse cterm=reverse
          hi IndentGuidesEven guifg={normal.black} guibg=#3c3836 gui=reverse cterm=reverse
        else
          hi IndentGuidesOdd guifg={normal.black} guibg=#504945 gui=NONE cterm=NONE
          hi IndentGuidesEven guifg={normal.black} guibg=#3c3836 gui=NONE cterm=NONE
        endif
      endif
      ...
      hi LspDiagnosticsDefaultError guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi LspDiagnosticsSignError guifg={bright.red} guibg={normal.black} gui=NONE cterm=NONE
      hi LspDiagnosticsUnderlineError guifg={bright.red} guibg=NONE guisp={bright.red} gui=undercurl cterm=underline
      hi LspDiagnosticsDefaultWarning guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi LspDiagnosticsSignWarning guifg={bright.yellow} guibg=#3c3836 gui=NONE cterm=NONE
      hi LspDiagnosticsUnderlineWarning guifg={bright.yellow} guibg=NONE guisp={bright.yellow} gui=undercurl cterm=underline
      hi LspDiagnosticsDefaultInformation guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi LspDiagnosticsSignInformation guifg={bright.blue} guibg=#3c3836 gui=NONE cterm=NONE
      hi LspDiagnosticsUnderlineInformation guifg={bright.blue} guibg=NONE guisp={bright.blue} gui=undercurl cterm=underline
      hi LspDiagnosticsDefaultHint guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi LspDiagnosticsSignHint guifg={bright.cyan} guibg=#3c3836 gui=NONE cterm=NONE
      hi LspDiagnosticsUnderlineHint guifg={bright.cyan} guibg=NONE guisp={bright.cyan} gui=undercurl cterm=underline
      hi LanguageClientError guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi LanguageClientErrorSign guifg={bright.red} guibg={normal.black} gui=NONE cterm=NONE
      hi LanguageClientWarning guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi LanguageClientWarningSign guifg={bright.yellow} guibg=#3c3836 gui=NONE cterm=NONE
      hi LangaugeClientInfo guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi LanguageClientInfoSign guifg={bright.blue} guibg=#3c3836 gui=NONE cterm=NONE
      hi LanguageClientCodeLens guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi NERDTreeDir guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi NERDTreeDirSlash guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      ...
      hi NERDTreeFile guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi NERDTreeExecFile guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi NERDTreeUp guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi NERDTreeCWD guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi NERDTreeHelp guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi NERDTreeToggleOn guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi NERDTreeToggleOff guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi netrwDir guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi netrwClassify guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi netrwLink guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi netrwSymLink guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi netrwExe guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi netrwComment guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi netrwList guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi netrwHelpCmd guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi netrwCmdSep guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
      hi netrwVersion guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      " Rainbow Parentheses
      if !exists('g:rbpt_colorpairs')
        let g:rbpt_colorpairs = [['blue', '{normal.blue}'], ['magenta', '{normal.magenta}'],
              \ ['red', '{normal.red}'], ['166', '#d65d0e']]
      endif

      let g:rainbow_guifgs = [ '#d65d0e', '{normal.red}', '{normal.magenta}', '{normal.blue}' ]
      let g:rainbow_ctermfgs = [ '166', 'red', 'magenta', 'blue' ]

      let g:niji_dark_colours = g:rbpt_colorpairs
      let g:niji_light_colours = g:rbpt_colorpairs
      hi ShowMarksHLl guifg={bright.blue} guibg=#3c3836 gui=NONE cterm=NONE
      hi ShowMarksHLu guifg={bright.blue} guibg=#3c3836 gui=NONE cterm=NONE
      hi ShowMarksHLo guifg={bright.blue} guibg=#3c3836 gui=NONE cterm=NONE
      hi ShowMarksHLm guifg={bright.blue} guibg=#3c3836 gui=NONE cterm=NONE
      hi SignifySignAdd guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi SignifySignChange guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi SignifySignDelete guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi SignatureMarkText guifg={bright.blue} guibg=#3c3836 gui=NONE cterm=NONE
      hi SignatureMarkerText guifg={bright.magenta} guibg=#3c3836 gui=NONE cterm=NONE
      hi StartifyBracket guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
      hi StartifyFile guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi StartifyNumber guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi StartifyPath guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi StartifySlash guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi StartifySection guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      ...
      hi SyntasticError guifg=NONE guibg=NONE guisp={bright.red} gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
      hi SyntasticWarning guifg=NONE guibg=NONE guisp={bright.yellow} gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
      hi SyntasticErrorSign guifg={bright.red} guibg=#3c3836 gui=NONE cterm=NONE
      hi SyntasticWarningSign guifg={bright.yellow} guibg=#3c3836 gui=NONE cterm=NONE
      ...
      let g:vimshell_escape_colors = [
            \ '#7c6f64', '{bright.red}', '{bright.green}', '{bright.yellow}',
            \ '{bright.blue}', '{bright.magenta}', '{bright.cyan}', '{normal.white}',
            \ '{normal.black}', '{bright.red}', '{bright.green}', '#fe8019',
            \ '{bright.blue}', '{bright.magenta}', '{bright.cyan}', '#fbf1c7'
            \ ]
    endif
    if get(g:, "gruvbox_filetype_hi_groups", 0)
      hi diffAdded guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi diffRemoved guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi diffChanged guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi diffFile guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi diffNewFile guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi diffLine guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi htmlTag guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi htmlEndTag guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi htmlTagName guifg={bright.cyan} guibg=NONE gui=bold cterm=bold
      hi htmlArg guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi htmlScriptTag guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi htmlTagN guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi htmlSpecialTagName guifg={bright.cyan} guibg=NONE gui=bold cterm=bold
      hi htmlLink guifg={normal.white} guibg=NONE gui=underline cterm=underline
      hi htmlSpecialChar guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi htmlBold guifg=fg guibg={normal.black} gui=bold cterm=bold
      hi htmlBoldUnderline guifg=fg guibg={normal.black} gui=bold,underline cterm=bold,underline
      hi htmlBoldItalic guifg=fg guibg={normal.black} gui=bold,italic cterm=bold,italic
      hi htmlBoldUnderlineItalic guifg=fg guibg={normal.black} gui=bold,italic,underline cterm=bold,italic,underline
      hi htmlUnderline guifg=fg guibg={normal.black} gui=underline cterm=underline
      hi htmlUnderlineItalic guifg=fg guibg={normal.black} gui=italic,underline cterm=italic,underline
      hi htmlItalic guifg=fg guibg={normal.black} gui=italic cterm=italic
      hi xmlTag guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi xmlEndTag guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi xmlTagName guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi xmlEqual guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi docbkKeyword guifg={bright.cyan} guibg=NONE gui=bold cterm=bold
      hi xmlDocTypeDecl guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi xmlDocTypeKeyword guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi xmlCdataStart guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi xmlCdataCdata guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi dtdFunction guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi dtdTagName guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi xmlAttrib guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi xmlProcessingDelim guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi dtdParamEntityPunct guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi dtdParamEntityDPunct guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi xmlAttribPunct guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi xmlEntity guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi xmlEntityPunct guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi vimCommentTitle guifg={normal.white} guibg=NONE gui=bold cterm=bold
      ...
      hi clojureKeyword guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      ...
      hi clojureFunc guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi clojureRepeat guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi clojureCharacter guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi clojureStringEscape guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi clojureException guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi clojureRegexp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi clojureRegexpEscape guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      ...
      hi clojureAnonArg guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi clojureVariable guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi clojureMacro guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi clojureMeta guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi clojureDeref guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi clojureQuote guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi clojureUnquote guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi cOperator guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      ...
      hi pythonFunction guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi pythonDecorator guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi pythonInclude guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi pythonImport guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi pythonRun guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi pythonCoding guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi pythonOperator guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi pythonException guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi pythonExceptions guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi pythonBoolean guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi pythonDot guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
      hi pythonConditional guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi pythonRepeat guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi pythonDottedName guifg={bright.green} guibg=NONE gui=bold cterm=bold
      hi cssBraces guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi cssFunctionName guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi cssIdentifier guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi cssClassName guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi cssColor guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi cssSelectorOp guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi cssSelectorOp2 guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi cssImportant guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi cssVendor guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi cssTextProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssAnimationProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssUIProp guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi cssTransformProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssTransitionProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssPrintProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssPositioningProp guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi cssBoxProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssFontDescriptorProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssFlexibleBoxProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssBorderOutlineProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssBackgroundProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssMarginProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssListProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssTableProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssFontProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssPaddingProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssDimensionProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssRenderProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssColorProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi cssGeneratedContentProp guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javaScriptBraces guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javaScriptFunction guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javaScriptIdentifier guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi javaScriptMember guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi javaScriptNumber guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi javaScriptNull guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi javaScriptParens guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
      hi javascriptImport guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javascriptExport guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javascriptClassKeyword guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javascriptClassExtends guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDefault guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javascriptClassName guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi javascriptClassSuperName guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi javascriptGlobal guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi javascriptEndColons guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptFuncArg guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptGlobalMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptNodeGlobal guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptBOMWindowProp guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptArrayMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptArrayStaticMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptCacheMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDateMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptMathStaticMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptURLUtilsProp guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptBOMNavigatorProp guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDOMDocMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDOMDocProp guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptBOMLocationMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptBOMWindowMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptStringMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      ...
      hi javascriptFuncKeyword guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javascriptAsyncFunc guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javascriptClassStatic guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi javascriptOperator guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi javascriptForOperator guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi javascriptYield guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi javascriptExceptions guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi javascriptMessage guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi javascriptTemplateSB guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi javascriptTemplateSubstitution guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptLabel guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptObjectLabel guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptPropertyName guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptLogicSymbols guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptArrowFunc guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDocParamName guifg={normal.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDocTags guifg={normal.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDocNotation guifg={normal.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDocParamType guifg={normal.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDocNamedParamType guifg={normal.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptBrackets guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDOMElemAttrs guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDOMEventMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDOMNodeMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptDOMStorageMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptHeadersMethod guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi javascriptAsyncFuncKeyword guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi javascriptAwaitFuncKeyword guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi jsImport guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi jsExport guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi jsFrom guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi jsThis guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi jsParen guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsOperator guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi jsSpreadOperator guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi jsSpreadExpression guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsClassKeyword guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi jsClassProperty guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi jsExtendsKeyword guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi jsExportDefault guifg=#fe8019 guibg=NONE gui=bold cterm=bold
      hi jsTemplateBraces guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi jsGlobalNodeObjects guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi jsGlobalObjects guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi jsFunction guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi jsFuncParens guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi jsFuncBlock guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsParens guifg=#bdae93 guibg=NONE gui=NONE cterm=NONE
      hi jsNull guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi jsUndefined guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi jsClassDefinition guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi jsFunctionKey guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi jsBracket guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi jsObjectColon guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi jsObjectProp guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsFuncBraces guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi jsVariableDef guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi jsObjectValue guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsDestructuringBlock guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi jsParenIfElse guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsClassBlock guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsFutureKeys guifg=#fe8019 guibg=NONE gui=bold cterm=bold
      hi jsStorageClass guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi jsModuleKeyword guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsObjectShorthandProp guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxRegion guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxTagName guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxComponentName guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi jsxEscapeJsAttributes guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxEscapeJsContent guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxAttrib guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi jsxAttributeBraces guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi jsxEqual guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi jsxString guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi jsxCloseTag guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxEndTag guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxEndString guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxCloseString guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxIfOperator guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi jsxElseOperator guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi jsxDot guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi jsxNamespace guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi jsxPunct guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptReserved guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptLabel guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptFuncKeyword guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptIdentifier guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi typeScriptBraces guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptEndColons guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptDOMObjects guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptAjaxMethods guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptLogicSymbols guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi! link typeScriptDocSeeTag Comment
      hi! link typeScriptDocParam Comment
      hi! link typeScriptDocTags vimCommentTitle
      hi typeScriptGlobalObjects guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      ...
      hi typeScriptHtmlElemProperties guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptNull guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi typeScriptInterpolationDelimiter guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi purescriptModuleKeyword guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi purescriptModuleName guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi purescriptWhere guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi purescriptDelimiter guifg={normal.white} guibg=NONE gui=NONE cterm=NONE
      hi purescriptType guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi purescriptImportKeyword guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi purescriptHidingKeyword guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi purescriptAsKeyword guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi purescriptStructure guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi purescriptOperator guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi purescriptTypeVar guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi purescriptConstructor guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi purescriptFunction guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      ...
      hi rubyStringDelimiter guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi rubyInterpolationDelimiter guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi objcTypeModifier guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi objcDirective guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi goDirective guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi goConstants guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi goDeclaration guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi goDeclType guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi goBuiltins guifg=#fe8019 guibg=NONE gui=NONE cterm=NONE
      hi luaIn guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi luaFunction guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      ...
      hi moonObject guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi javaAnnotation guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      hi javaDocTags guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      ...
      hi javaVarArg guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi! link elixirDocString Comment
      hi elixirStringDelimiter guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi elixirInterpolationDelimiter guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi elixirModuleDeclaration guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi scalaNameDefinition guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi scalaCaseFollowing guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi scalaCapitalWord guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi scalaTypeExtension guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi scalaKeyword guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi scalaKeywordModifier guifg={bright.red} guibg=NONE gui=NONE cterm=NONE
      hi scalaSpecial guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi scalaOperator guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi scalaTypeDeclaration guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi scalaTypeTypePostDeclaration guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi scalaInstanceDeclaration guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi scalaInterpolation guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi markdownItalic guifg=#bdae93 guibg=NONE gui=italic cterm=italic
      hi markdownH1 guifg={bright.green} guibg=NONE gui=bold cterm=bold
      hi markdownH2 guifg={bright.green} guibg=NONE gui=bold cterm=bold
      hi markdownH3 guifg={bright.yellow} guibg=NONE gui=bold cterm=bold
      hi markdownH4 guifg={bright.yellow} guibg=NONE gui=bold cterm=bold
      hi markdownH5 guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi markdownH6 guifg={bright.yellow} guibg=NONE gui=NONE cterm=NONE
      hi markdownCode guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi markdownCodeBlock guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi markdownCodeDelimiter guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi markdownBlockquote guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi markdownListMarker guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi markdownOrderedListMarker guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi markdownRule guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      hi markdownHeadingRule guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
      ...
      hi markdownUrl guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi markdownUrlTitleDelimiter guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi markdownLinkText guifg={bright.black} guibg=NONE gui=underline cterm=underline
      hi! link markdownIdDeclaration markdownLinkText
      hi haskellType guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi haskellIdentifier guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi haskellSeparator guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi haskellDelimiter guifg={normal.white} guibg=NONE gui=NONE cterm=NONE
      hi haskellOperators guifg={bright.blue} guibg=NONE gui=NONE cterm=NONE
      ...
      hi haskellLet guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi haskellDefault guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi haskellWhere guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi haskellBottom guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi haskellBlockKeywords guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi haskellImportKeywords guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi haskellDeclKeyword guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi haskellDeriving guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi haskellAssocType guifg={bright.cyan} guibg=NONE gui=NONE cterm=NONE
      hi haskellNumber guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi haskellPragma guifg={bright.magenta} guibg=NONE gui=NONE cterm=NONE
      hi haskellString guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi haskellChar guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi jsonKeyword guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi jsonQuote guifg={bright.green} guibg=NONE gui=NONE cterm=NONE
      hi jsonBraces guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      hi jsonString guifg={bright.white} guibg=NONE gui=NONE cterm=NONE
      if !s:italics
  ...
  " Light background
  let g:terminal_ansi_colors = ['#3c3836', '{normal.red}', '{normal.green}', '{normal.yellow}', '{normal.blue}', '{normal.magenta}', '{normal.cyan}', '#7c6f64', '{bright.black}', '#9d0006', '#79740e', '#b57614', '#076678', '#8f3f71', '#427b58', '#fbf1c7']
  if has('nvim')
  ...
  if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
    ...
    hi CursorLineNr guifg=#b57614 guibg={bright.white} gui=NONE cterm=NONE
    hi FoldColumn guifg={bright.black} guibg={bright.white} gui=NONE cterm=NONE
    hi SignColumn guifg=#3c3836 guibg={bright.white} gui=NONE cterm=NONE
    hi VertSplit guifg=#bdae93 guibg=#fbf1c7 gui=NONE cterm=NONE
  endif
  hi ColorColumn guifg=NONE guibg={bright.white} gui=NONE cterm=NONE
  hi Comment guifg={bright.black} guibg=NONE gui=italic cterm=italic
  hi CursorLine guifg=NONE guibg={bright.white} gui=NONE cterm=NONE
  ...
  hi Folded guifg={bright.black} guibg={bright.white} gui=italic cterm=italic
  hi LineNr guifg={normal.white} guibg=NONE gui=NONE cterm=NONE
  ...
  hi PmenuThumb guifg=NONE guibg={normal.white} gui=NONE cterm=NONE
  hi SpecialKey guifg={bright.black} guibg=NONE gui=NONE cterm=NONE
  hi StatusLine guifg=#d5c4a1 guibg=#3c3836 gui=reverse cterm=reverse
  hi StatusLineNC guifg={bright.white} guibg=#7c6f64 gui=reverse cterm=reverse
  hi TabLine guifg={normal.white} guibg={bright.white} gui=NONE cterm=NONE
  hi TabLineFill guifg={normal.white} guibg={bright.white} gui=NONE cterm=NONE
  hi TabLineSel guifg=#79740e guibg={bright.white} gui=NONE cterm=NONE
  hi ToolbarButton guifg={normal.black} guibg=#bdae93 gui=bold cterm=bold
  ...
  if has('nvim')
    hi! link TermCursor Cursor
    hi TermCursorNC guifg={bright.white} guibg=#3c3836 gui=NONE cterm=NONE
  endif
  if !(get(g:, 'gruvbox_plugin_hi_groups', 0) || get(g:, 'gruvbox_filetype_hi_groups', 0))
    finish
  endif
  if get(g:, "basic_plugin_hi_groups", 0)
    ...
    hi ALEErrorSign guifg=#9d0006 guibg={bright.white} gui=NONE cterm=NONE
    hi ALEWarningSign guifg=#b57614 guibg={bright.white} gui=NONE cterm=NONE
    hi ALEInfoSign guifg=#076678 guibg={bright.white} gui=NONE cterm=NONE
    ...
    hi BufTabLineHidden guifg={normal.white} guibg={bright.white} gui=NONE cterm=NONE
    ...
    hi CocSelectedText guifg={bright.white} guibg=#fbf1c7 gui=NONE cterm=NONE
    ...
    if get(g:, 'basic_transp_bg', 0)
      ...
      hi GitGutterAdd guifg=#79740e guibg={bright.white} gui=NONE cterm=NONE
      hi GitGutterChange guifg=#427b58 guibg={bright.white} gui=NONE cterm=NONE
      hi GitGutterDelete guifg=#9d0006 guibg={bright.white} gui=NONE cterm=NONE
      hi GitGutterChangeDelete guifg=#427b58 guibg={bright.white} gui=NONE cterm=NONE
    endif
    if get(g:, 'indent_guides_auto_colors', 0)
      if get(g:, 'basic_invert_indent_guides', 0)
        hi IndentGuidesOdd guifg=#fbf1c7 guibg=#d5c4a1 gui=reverse cterm=reverse
        hi IndentGuidesEven guifg=#fbf1c7 guibg={bright.white} gui=reverse cterm=reverse
      else
        hi IndentGuidesOdd guifg=#fbf1c7 guibg=#d5c4a1 gui=NONE cterm=NONE
        hi IndentGuidesEven guifg=#fbf1c7 guibg={bright.white} gui=NONE cterm=NONE
      endif
    endif
    if !exists('g:indentLine_color_term')
    ...
    hi LspDiagnosticsSignWarning guifg=#b57614 guibg={bright.white} gui=NONE cterm=NONE
    ...
    hi LspDiagnosticsSignInformation guifg=#076678 guibg={bright.white} gui=NONE cterm=NONE
    ...
    hi LspDiagnosticsSignHint guifg=#427b58 guibg={bright.white} gui=NONE cterm=NONE
    ...
    hi LanguageClientWarningSign guifg=#b57614 guibg={bright.white} gui=NONE cterm=NONE
    hi LangaugeClientInfo guifg=#076678 guibg=NONE gui=NONE cterm=NONE
    hi LanguageClientInfoSign guifg=#076678 guibg={bright.white} gui=NONE cterm=NONE
    ...
    let g:niji_dark_colours = g:rbpt_colorpairs
    let g:niji_light_colours = g:rbpt_colorpairs
    hi ShowMarksHLl guifg=#076678 guibg={bright.white} gui=NONE cterm=NONE
    hi ShowMarksHLu guifg=#076678 guibg={bright.white} gui=NONE cterm=NONE
    hi ShowMarksHLo guifg=#076678 guibg={bright.white} gui=NONE cterm=NONE
    hi ShowMarksHLm guifg=#076678 guibg={bright.white} gui=NONE cterm=NONE
    ...
    hi SignatureMarkText guifg=#076678 guibg={bright.white} gui=NONE cterm=NONE
    hi SignatureMarkerText guifg=#8f3f71 guibg={bright.white} gui=NONE cterm=NONE
    ...
    hi SyntasticErrorSign guifg=#9d0006 guibg={bright.white} gui=NONE cterm=NONE
    hi SyntasticWarningSign guifg=#b57614 guibg={bright.white} gui=NONE cterm=NONE
    hi multiple_cursors_cursor guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
    hi multiple_cursors_visual guifg=NONE guibg=#d5c4a1 gui=NONE cterm=NONE
    let g:vimshell_escape_colors = [
          \ '{normal.white}', '#9d0006', '#79740e', '#b57614',
          \ '#076678', '#8f3f71', '#427b58', '#7c6f64',
          \ '#fbf1c7', '#9d0006', '#79740e', '#af3a03',
          \ '#076678', '#8f3f71', '#427b58', '{normal.black}'
          \ ]
  endif
